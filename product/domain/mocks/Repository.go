...
func (_m *Repository) Create(_a0 domain.Product) (domain.Product, error) {
	ret := _m.Called(_a0)
...
func (_m *Repository) Get() ([]domain.Product, error) {
	ret := _m.Called()
...
func (_m *Repository) GetByID(id int) (domain.Product, error) {
	ret := _m.Called(id)
...
func (_m *Repository) Update(id int, _a1 domain.Product) (domain.Product, error) {
